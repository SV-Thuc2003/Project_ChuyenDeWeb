...
const FilterSection: React.FC<FilterSectionProps> = ({
  ...
  return (
      <aside className="w-full">
        {/* Brands */}
        <div className="mb-8">
          <h3 className="text-xl font-semibold mb-4">{t('filter.brand')}</h3>
        ...
        {/* Price Range */}
        <div className="mb-8">
          <h3 className="text-xl font-semibold mb-4">{t('filter.price')}</h3>
          <input
              type="range"
              min={200000}
              max={10000000}
          ...
          <p className="mt-4 text-base font-medium">
            {t('filter.priceLabel', {
              min: localPriceRange.min.toLocaleString(),
              max: localPriceRange.max.toLocaleString(),
            })}
          </p>
          <Button
              variant="primary"
        ...
        {/* Tags */}
        <div className="mb-8">
          <h3 className="text-xl font-semibold mb-4">{t('filter.tag')}</h3>
